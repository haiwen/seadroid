...
public class AutoBackupFolderFileLoader extends AsyncTaskLoader<List<SelectableFile>> {
	...
	public AutoBackupFolderFileLoader(Context context, String path, List<File> selectedFiles) {
		super(context);
		this.mPath = path;
	...
	public List<SelectableFile> loadInBackground() {
		return Utils.getImageFoldersList(mPath, mSelectedFiles);
	}
