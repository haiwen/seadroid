...
public abstract class TransferManager {
    ...
    public static final String BROADCAST_ACTION = "com.horizonbase.seadroid.TX_BROADCAST";
     ...
     *
     * @return true, if there are tasks whose {@link com.horizonbase.seadroid2.transfer.TaskState} is {@code TRANSFERRING}.
     *          false, otherwise.
     */
