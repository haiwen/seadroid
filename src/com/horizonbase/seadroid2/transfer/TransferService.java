...
public class TransferService extends Service {
     ...
     *
     * Note: when deleting all tasks whose state is {@link com.horizonbase.seadroid2.transfer.TaskState#TRANSFERRING} in the queue,
     * other tasks left will never be executed, because they are all in the {@link com.horizonbase.seadroid2.transfer.TaskState#INIT} state.
