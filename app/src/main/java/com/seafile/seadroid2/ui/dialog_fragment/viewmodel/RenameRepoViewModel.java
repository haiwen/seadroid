...
public class RenameRepoViewModel extends BaseViewModel {
    ...
    public void renameRepo(String repoName, String repoId) {
        ...
        Single<String> single = IO.getSingleton().execute(DialogService.class).renameRepo(repoId, bodyMap);
    ...
    public void renameDir(String repoId, String curPath, String newName) {
        ...
        Single<String> single = IO.getSingleton().execute(DialogService.class).renameDir(repoId, curPath, bodyMap);
    ...
    public void renameFile(String repoId, String curPath, String newName) {
        ...
        Single<FileCreateModel> single = IO.getSingleton().execute(DialogService.class).renameFile(repoId, curPath, bodyMap);
