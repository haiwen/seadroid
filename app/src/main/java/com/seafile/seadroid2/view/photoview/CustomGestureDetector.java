...
public class CustomGestureDetector {
    ...
    private float getActiveX(MotionEvent ev) {
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                return ev.getRawX(mActivePointerIndex);
            } else {
    ...
    private float getActiveY(MotionEvent ev) {
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                return ev.getRawY(mActivePointerIndex);
            } else {
...
//                SLogs.e("C - onMove = x: " + x + ", y: " + y + ", lastX: " + mLastTouchX + ", lastY: " + mLastTouchY + ", dx: " + dx + ", dy: " + dy + ", mIsDragging: " + mIsDragging);
