...
public class HeicNative {
    ...
    public static native String nativeConvertHeicMotionPhotoToJpeg(String heicFilePath, String vendor, String outputPath);
    ...
    public static native String nativeExtractHeicMotionPhotoXMP(String inputFilePath);
