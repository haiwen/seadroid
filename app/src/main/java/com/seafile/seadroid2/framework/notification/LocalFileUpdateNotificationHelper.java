...
public class LocalFileUpdateNotificationHelper extends BaseTransferNotificationHelper {
    public LocalFileUpdateNotificationHelper(Context context) {
        super(context);
    }
    ...
    public String getDefaultTitle() {
        return context.getString(R.string.update_file);
    }
